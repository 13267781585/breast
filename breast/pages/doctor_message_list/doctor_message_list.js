...
Page({
  ...
  to_chatroom(option) {
    ...
    wx.navigateTo({
      url: '../consult_chatroom/consult_chatroom?otherId=' + otherId +
       '&oid=' + oid + '&otherImg=' + encodeURIComponent(JSON.stringify(otherImg)) + '&id=' + id + '&img=' + 
       encodeURIComponent(JSON.stringify(img)),
    })
  },
